              ...
              <SelectTrigger>
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem value="horror">Chair</SelectItem>
                    <SelectItem value="fantasy">Table</SelectItem>
                    <SelectItem value="adventure">Bed</SelectItem>
                    <SelectItem value="adventure">Sofa</SelectItem>
                    <SelectItem value="adventure">Wardrobe</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </SelectTrigger>
            </Select>
